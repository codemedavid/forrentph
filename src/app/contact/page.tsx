              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@costumerental.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Extended hours available by appointment</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    We recommend booking at least 1-2 weeks in advance, especially for popular costumes and peak seasons.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Cancellations made 24 hours before the rental start date receive a full refund. Later cancellations may incur fees.
                  </p>
                </div>
                
                <div>
                  <h4 className="font-medium text-gray-900 mb-2">Do you offer delivery and pickup?</h4>
                  <p className="text-gray-600 text-sm">
                    Yes! We offer delivery and pickup services within a 20-mile radius for an additional fee.
                  </p>
                </div>
